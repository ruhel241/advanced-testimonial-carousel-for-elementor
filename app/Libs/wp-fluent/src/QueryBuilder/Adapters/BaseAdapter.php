<?php namespace AdvancedTestimonialCarouselFluent\QueryBuilder\Adapters;

use AdvancedTestimonialCarouselFluent\Connection;
use AdvancedTestimonialCarouselFluent\Exception;
use AdvancedTestimonialCarouselFluent\QueryBuilder\Raw;

abstract class BaseAdapter
{
    /**
     * @var \AdvancedTestimonialCarouselFluent\Connection
     */
        ...
        foreach ($statements as $statement) {
            ...
            if (is_null($value) && $key instanceof \Closure) {
                ...
                $nestedCriteria = $this->container->build(
                    '\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\NestedCriteria',
