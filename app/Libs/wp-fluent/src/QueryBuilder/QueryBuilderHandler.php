<?php namespace AdvancedTestimonialCarouselFluent\QueryBuilder;

use AdvancedTestimonialCarouselFluent\Connection;
use AdvancedTestimonialCarouselFluent\Exception;
...
class QueryBuilderHandler
{
    ...
    /**
     * @var \AdvancedTestimonialCarouselFluent\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\AdvancedTestimonialCarouselFluent\Connection $connection
     *
     * @throws \AdvancedTestimonialCarouselFluent\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\Raw', array($value, $bindings));
    }
