<?php namespace AdvancedTestimonialCarouselFluent;
...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\AdvancedTestimonialCarouselFluent\\EventHandler');
    ...
    {
        class_alias('AdvancedTestimonialCarouselFluent\\AliasFacade', $alias);

        $builder = $this->container->build('\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\AdvancedTestimonialCarouselFluent\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
